...
<h2 class="text-center mb-5"><?= isset($currentUser) ? "Modification de votre Avatar" : "Création de votre Avatar" ?>
</h2>
                ...
                <div class="card-body d-flex flex-column justify-content-center">
                    ...
                    <?php if (isset($currentUser)): ?>
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control mb-2" id="pwd" name="password"
                    ...
                    <?php else: ?>
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="pwd_confirm_create"
...
<script>
    ...
    function render() {
        ...
        if (worlds && worlds.length > 0) {
            ...
            document.getElementById('current-world-name').innerText = wd.nameWorld;
